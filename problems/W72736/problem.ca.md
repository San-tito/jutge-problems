...
Has d'implementar `tree_of_sums` en un **fitxer `.cc` nou**, compilar
...
resultant d'aplicar la funció `tree_of_sums`. (La sortida també la fa el
programa principal.)
...
Generació: 2026-01-25T13:19:45.774Z
