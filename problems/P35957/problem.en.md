...
immedialty. If after writing the $2n$ numbers nobody loses, the game
ends in a draw.
...
Input consists of a natural number $n\ge 1$, followed by $2n$ natural
numbers $a_1, b_1, \dots, a_n, b_n$: $a_1$ is the first number of Anna,
$b_1$ is the first number of Bernard, $a_2$ is the second number of
Anna, etcetera.

## Output

Print '`A`', '`B`', or '`=`', depending on whether Anna wins, Bernard
wins, or it is a tie.
